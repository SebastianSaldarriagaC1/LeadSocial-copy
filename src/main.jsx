...
const router = createBrowserRouter([
  ...
  { path: "/onboarding/returning", element: <ReturningUserPage /> },
  ...
  {
    path: "/onboarding/returning-user",
    element: <Navigate to="/onboarding/returning" replace />,
  },
